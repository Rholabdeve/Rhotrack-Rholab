                        ...
                        Column(
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                'Payment Status : ${widget.payment_status}',
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w700,
                                  color: widget.payment_status == "paid"
                                      ? Colors.green
                                      : widget.payment_status == "pending"
                                          ? Colors.amber
                                          : widget.payment_status == "partial"
                                              ? Colors.orange
                                              : Colors
